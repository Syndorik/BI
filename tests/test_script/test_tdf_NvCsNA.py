...
print("Tests : table_de_fait_NvCsNA")
...
PATH = myparser.dir[0]
PATH_TEST = ".\\csv_true\\ft_nivCsnonAtteint\\"

cpt = 0
ft_nivCsnonAtteint = pd.read_csv(PATH)
...
for k in numbers: 
    ...
    tocompareto = ft_nivCsnonAtteint[ft_nivCsnonAtteint["std_ID"] == k].reset_index().drop("index",axis=1)
