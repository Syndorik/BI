...
print("Tests : table_de_fait_Rstcg")
...
PATH = myparser.dir[0]
PATH_TEST = ".\\csv_true\\ft_cgnote\\"

cpt = 0
ft_cgnote = pd.read_csv(PATH)
...
for k in numbers: 
    ...
    tocompareto = ft_cgnote[ft_cgnote["std_ID"] == k].reset_index().drop("index",axis=1)
