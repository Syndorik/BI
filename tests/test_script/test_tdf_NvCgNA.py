...
print("Tests : table_de_fait_NvCgNa")
...
PATH = myparser.dir[0]
PATH_TEST = ".\\csv_true\\ft_nivCgnonAtteint\\"

cpt = 0
ft_nivCgnonAtteint = pd.read_csv(PATH)
...
for k in numbers: 
    ...
    tocompareto = ft_nivCgnonAtteint[ft_nivCgnonAtteint["std_ID"] == k].reset_index().drop("index",axis=1)
